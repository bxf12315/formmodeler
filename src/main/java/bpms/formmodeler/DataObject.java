...
public class DataObject implements java.io.Serializable {
	...
	private bpms.formmodeler.NestedDataObject subform;

	private java.util.List<bpms.formmodeler.NestedDataObject> multipleSubform;
	...
	public bpms.formmodeler.NestedDataObject getSubform() {
		return this.subform;
	}

	public void setSubform(bpms.formmodeler.NestedDataObject subform) {
		this.subform = subform;
	}

	public java.util.List<bpms.formmodeler.NestedDataObject> getMultipleSubform() {
		return this.multipleSubform;
	}

	public void setMultipleSubform(
			java.util.List<bpms.formmodeler.NestedDataObject> multipleSubform) {
	...
	public DataObject(
			...
			bpms.formmodeler.NestedDataObject subform,
			java.util.List<bpms.formmodeler.NestedDataObject> multipleSubform) {
		this.stringTextBox = stringTextBox;
		this.intIntegerBox = intIntegerBox;
		this.stringMultipleSelector = stringMultipleSelector;
